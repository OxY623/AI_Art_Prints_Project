...
class Print(models.Model):
    ...
    price = models.DecimalField(max_digits=6, decimal_places=2,
                                validators=[MaxValueValidator(99999), MinValueValidator(0.02)],
...
class CartPrint(models.Model):
    ...
    quantity = models.PositiveIntegerField(default=1,  validators=[MaxValueValidator(50), MinValueValidator(1)],
                                   help_text='Enter a value between 1 and 50.')
